...
for epoch in range(num_epochs): 
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(res_dict, os.path.join(checkpoint_dir, 'model_best_eps{:0.2f}.t7'.format(epsilon)))
...
checkpoint = torch.load(os.path.join(checkpoint_dir, 'model_best_eps{:0.2f}.t7'.format(epsilon)))
